...
RUN python3.9 -m pip install numpy  pandas pysam PyVCF scikit-learn scipy statistics vireoSNP pyfaidx pystan && git clone https://github.com/jon-xu/scSplit #scsplit + vireo
ENV PATH="$PATH:/home/scSplit"
...
RUN python3.9 -m pip install tensorflow #--upgrade https://storage.googleapis.com/tensorflow/mac/cpu/tensorflow-1.12.0-py3-none-any.whl #tensorflow for souporcell
